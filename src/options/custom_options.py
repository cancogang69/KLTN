...
def parse_args():
    ...
    parser.add_argument('--unet-backbone', type=str, default='resnet50')
    ...
    parser.add_argument("--use-precalculate-sdf", action="store_true", default=False)
    parser.add_argument("--sdf-train-root", type=str, default="sdf_train_root")
    parser.add_argument("--sdf-val-root", type=str, default="sdf_val_root")
